...
def load_F0_models(path):
    ...
    try:
        ...
        warn_messsage = (
            f"Could not load F0 model from {path} using the original implementation. "
            "This is normal if you finetuned a new JDC-PitchExtractor with .pth extension and passed "
            "to the config file. If not, please investigate this issue."
        )
        logging.warn(warn_messsage)
